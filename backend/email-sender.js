...
function getPurchaseEmailTemplate(language, orderId) {
  if (language === 'es') {
    return {
      ...
      track_link: `Puede <a href="${process.env.NEXT_PUBLIC_URL}/order-status/${orderId}">seguir su pedido aquí</a>.`,
  ...
  if (language === 'pt-BR') {
    return {
      ...
      track_link: `Você pode <a href="${process.env.NEXT_PUBLIC_URL}/order-status/${orderId}">acompanhar seu pedido aqui</a>.`,
  ...
  if (language === 'pt') {
    return {
      subject: 'Confirmação de Compra',
      title: 'Obrigado pela sua compra!',
      track_link: `Pode <a href="${process.env.NEXT_PUBLIC_URL}/order-status/${orderId}">acompanhar o seu pedido aqui</a>.`,
  ...
  return {
    ...
    track_link: `You can <a href="${process.env.NEXT_PUBLIC_URL}/order-status/${orderId}">track your order here</a>.`,
