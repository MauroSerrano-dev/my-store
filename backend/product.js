 ...
 */
async function updateProduct(new_product, inicial_product) {
    if (!new_product?.id || !new_product || !inicial_product)
    ...
    try {
        ...
        if (Object.keys(getObjectsDiff(productDoc.data(), inicial_product)).length !== 0)
