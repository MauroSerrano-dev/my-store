...
export function getProductPrintifyIdsUniquePosition(printify_ids, position) {
    return Object.keys(printify_ids).reduce((acc, provider_id) => ({ ...acc, [provider_id]: typeof printify_ids[provider_id] === 'object' ? printify_ids[provider_id][position] : printify_ids[provider_id] }), {})
}